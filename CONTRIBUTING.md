...
* ramsey/http-range follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  ramsey/http-range automatically runs tests for pull requests. However,
...
[github]: https://github.com/ramsey/http-range
[issues]: https://github.com/ramsey/http-range/issues
[pull requests]: https://github.com/ramsey/http-range/pulls
